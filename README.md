...
```
cd existing_repo
git remote add origin http://192.168.110.116/fgw-group/fgw-backend.git
git branch -M main
...
- [ ] [Set up project integrations](http://192.168.110.116/fgw-group/fgw-backend/-/settings/integrations)
